			...
			<div class="main">  	
				...
				<div class="signup">
					<form action="{{ route('register') }}" method="POST">
						...
						<input id="input" type="text" name="name" placeholder="User name" required="">
						...
						<input id="input" type="password" name="password_confirmation" placeholder="Conferma password" required="">
